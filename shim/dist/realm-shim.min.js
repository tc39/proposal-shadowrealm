...
return Realm;
  ...
  `)(b);d.Realm=e,K.set(e.prototype,a)}function o(a){const b=a[r],c=w(b.ObjectPrototype);a[s]=c}function p(a){const d=b(a),e=c(a);a[t]=d;const f=a[r];f.eval=d,f.Function=e}function q(a){const b=a[r],c=j(b);x(a[s],c)}const r=Symbol('Intrinsics Slot'),s=Symbol('GlobalObject Slot'),t=Symbol('DirectEvalEvaluator Slot'),u=Symbol('Shim Sandbox'),{assign:v,create:w,defineProperties:x,freeze:y,getOwnPropertyDescriptors:z,getOwnPropertyNames:A}=Object,{apply:B,defineProperty:C,deleteProperty:D,getOwnPropertyDescriptor:E,getPrototypeOf:F,ownKeys:G,setPrototypeOf:H}=Reflect;class I{constructor(a){const{unsafeGlobal:b}=a;this.unsafeGlobal=b,this.isInternalEvaluation=!1}get(a,b){return'eval'===b?this.isInternalEvaluation?(this.isInternalEvaluation=!1,this.unsafeGlobal.eval):a.eval:b in a?a[b]:void 0}has(a,b){return'eval'===b||'arguments'!==b&&(!!(b in a)||!!(b in this.unsafeGlobal))}}const J=new WeakMap,K=new WeakMap;class L{constructor(a){const b=this,c=Object(a);let d,e=c.intrinsics;if('inherit'===e)d=K.get(F(this));else if(void 0===e)d=i(),n(d,L);else throw new TypeError('Realm only supports undefined or "inherited" intrinsics.');e=k(d);const f={[u]:d,[r]:e,[s]:void 0,[t]:void 0};J.set(b,f),o(f);const g=b.init;if(!l(g))throw new TypeError;g.call(b)}init(){const a=this;if('object'!=typeof a)throw new TypeError;if(!J.has(a))throw new TypeError;const b=J.get(a);p(b),q(b)}get intrinsics(){const a=this;if('object'!=typeof a)throw new TypeError;if(!J.has(a))throw new TypeError;const b=J.get(a),c=b[r],d=w(c.ObjectPrototype);return v(d,c)}get global(){const a=this;if('object'!=typeof a)throw new TypeError;if(!J.has(a))throw new TypeError;const b=J.get(a);return b[s]}evaluate(a){const b=this;if('object'!=typeof b)throw new TypeError;if(!J.has(b))throw new TypeError;const c=J.get(b),d=c[t];return d(a)}}return L.toString=()=>'function Realm() { [shim code] }',K.set(L.prototype,function(){const a=m(),b=i(a);return b}()),L});
