...
return Realm;
  ...
  `)(q,v,a)}function n(a){const b=a[s],c=x(b.ObjectPrototype);c[r]=a,a[t]=c}function o(a){const d=b(a),e=c(a);a[u]=d;const f=a[s];f.eval=d,f.Function=e}function p(a){const b=a[s],c=j(b);y(a[t],c)}function q(a){const b=this,c=Object(a);let d,e=c.intrinsics;if('inherit'===e)d=v in b?b[v]:K;else if(void 0===e)d=i(),m(d);else throw new TypeError('Realm only supports undefined or "inherited" intrinsics.');e=k(d);const f={[v]:d,[s]:e,[t]:void 0,[u]:void 0};n(f),o(f),p(f),b[r]=f}const r=Symbol('Realm Slot'),s=Symbol('Intrinsics Slot'),t=Symbol('GlobalObject Slot'),u=Symbol('DirectEvalEvaluator Slot'),v=Symbol('Shim Sandbox'),{assign:w,create:x,defineProperties:y,freeze:z,getOwnPropertyDescriptors:A,getOwnPropertyNames:B}=Object,{apply:C,defineProperty:D,deleteProperty:E,getOwnPropertyDescriptor:F,getPrototypeOf:G,ownKeys:H,setPrototypeOf:I}=Reflect;class J{constructor(a){const{unsafeGlobal:b}=a;this.unsafeGlobal=b,this.isInternalEvaluation=!1}get(a,b){return'eval'===b?this.isInternalEvaluation?(this.isInternalEvaluation=!1,this.unsafeGlobal.eval):a.eval:b in a?a[b]:void 0}has(a,b){return'eval'===b||'arguments'!==b&&(!!(b in a)||!!(b in this.unsafeGlobal))}}const K=function(){const a=l(),b=i(a);return b}();return y(q.prototype,{intrinsics:{get(){const a=this;if('object'!=typeof a)throw new TypeError;if(!(r in a))throw new TypeError;const b=a[r][s],c=x(b.ObjectPrototype);return w(c,b)}},global:{get(){const a=this;if('object'!=typeof a)throw new TypeError;if(!(r in a))throw new TypeError;return a[r][t]}},evaluate:{value(a){const b=this;if('object'!=typeof b)throw new TypeError;if(!(r in b))throw new TypeError;const c=b[r],d=c[u];return d(a)}}}),q.toString=()=>'function Realm() { [shim code] }',q});
