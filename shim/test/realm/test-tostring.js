...
test('eval.toString', t => {
  ...
  t.equal(r.evaluate('Object.getPrototypeOf(eval.toString)'), r.global.Function.prototype,
          "eval has correct prototype");
  t.notEqual(r.evaluate('Object.getPrototypeOf(eval.toString)'), Function.prototype,
